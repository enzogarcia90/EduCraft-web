...
function renderPolicyPanel() {
	...
	node.innerHTML = `
		...
		<div class="local-worlds-warning" role="note"><strong>Comprobacion necesaria</strong><span>Los mundos locales se desactivan automaticamente por defecto. Este control guarda la politica, pero no confirma que todos los clientes ya hayan aplicado el permiso. Compruebalo desde el cliente antes de darlo por disponible.</span></div>
